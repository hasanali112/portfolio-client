    ...
    >
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {blogs.map((blog: IBlog) => (
            <Link key={blog._id} href={`/blogs/${blog._id}`}>
              <div className="group bg-gradient-to-br from-slate-800/50 to-slate-900/50 rounded-lg overflow-hidden border relative border-slate-700/50 hover:border-gray-500/50 transition-all duration-300 hover:transform">
        ...
        <div className="flex justify-center mt-12">
          <a href="/blogs">
            <button className="px-6 py-3 rounded-full border border-gray-500/30 text-gray-400 text-sm flex items-center gap-2 hover:border-gray-400/50 hover:bg-gray-500/5 transition-all">
              <Sparkles className="w-4 h-4" />
              <span>See More</span>
            </button>
          </a>
